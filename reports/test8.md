...
change sum to concat, add mlp to reduce dim
...
MyModel(
  ...
  (selfAttn): ScaledDotProductAttention(
    (fc_q): Linear(in_features=512, out_features=2048, bias=True)
    (fc_k): Linear(in_features=512, out_features=2048, bias=True)
    (fc_v): Linear(in_features=512, out_features=2048, bias=True)
    (fc_o): Linear(in_features=2048, out_features=512, bias=True)
