...
MyModel(
  ...
  (localbranch): BranchResNet(
    (convblock1): Sequential(
      (0): Conv2d(3, 128, kernel_size=(3, 3), stride=(2, 2), padding=(2, 2), bias=False)
    ...
    (resblock1): ResidualBlock(
      ...
      (relu): ReLU(inplace=True)
      (conv2): Conv2d(205, 205, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
      (bn2): BatchNorm2d(205, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
      (shortcut): Sequential(
        (0): Conv2d(128, 205, kernel_size=(1, 1), stride=(2, 2), bias=False)
        (1): BatchNorm2d(205, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
      )
    )
    (resblock2): ResidualBlock(
      (conv1): Conv2d(205, 256, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
      (bn1): BatchNorm2d(256, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
      (relu): ReLU(inplace=True)
      (conv2): Conv2d(256, 256, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
      (bn2): BatchNorm2d(256, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
      (shortcut): Sequential(
        (0): Conv2d(205, 256, kernel_size=(1, 1), stride=(1, 1), bias=False)
    ...
    (resblock3): ResidualBlock(
      ...
      (bn2): BatchNorm2d(205, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
      (shortcut): Sequential(
        (0): Conv2d(256, 205, kernel_size=(1, 1), stride=(1, 1), bias=False)
        (1): BatchNorm2d(205, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
      )
    )
    (adptAvgPool2d): AdaptiveAvgPool2d(output_size=(16, 16))
  )
...
def augmentation(image):
    ...
    augmentation_pipeline = A.Compose([
        ...
        A.OneOf([
            A.RandomRain(slant_lower=-10, slant_upper=10, drop_length=10, drop_width=1, blur_value=3, brightness_coefficient=0.9, p=0.4),
            A.RandomSunFlare(flare_roi=(0.2, 0.2, 0.8, 0.8), angle_lower=0.3, src_radius=150,num_flare_circles_range=[4,6], p=0.4),
        ], p=0.6),
