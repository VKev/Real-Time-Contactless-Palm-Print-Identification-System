...
from depth_estimation.utils import image2tensor, interpolate_np, apply_depth_mask_np
...
def stream(request: Request, triton: TritonClient, to_roi: bool = False):
    ...
    while True:
        ...
        tensor, (h,w) = image2tensor(frame, input_size=252)
        ...
        frame = apply_depth_mask_np(frame, depth_norm, threshold=0.6)
